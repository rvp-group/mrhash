...
namespace gs {
  ...
  public:
    ...
    static torch::autograd::tensor_list backward(torch::autograd::AutogradContext* ctx,
      ...
      auto [grad_means2D,
            ...
            grad_sh,
            grad_scales,
            grad_rotations] = RasterizeGaussiansBackwardCUDA(ctx->saved_data["background"].to<torch::Tensor>(),
                                                             means3D,
                                                             radii,
                                                             colors_precomp,
                                                             scales,
  ...
  public:
    ...
    std::tuple<torch::Tensor, torch::Tensor> forward(torch::Tensor means3D,
      ...
      auto result =
        rasterize_gaussians(means3D, means2D, shs, colors_precomp, opacities, scales, rotations, cov3D_precomp, raster_settings_);
