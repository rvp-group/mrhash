...
name2label      = { label.name    : label for label in kitti_360_labels           }
# id to label object
id2label        = { label.id      : label for label in kitti_360_labels           }
# trainId to label object
trainId2label   = { label.trainId : label for label in reversed(kitti_360_labels) }
# KITTI-360 ID to cityscapes ID
kittiId2label   = { label.kittiId : label for label in kitti_360_labels           }
# category to list of label objects
category2kitti_360_labels = {}
for label in kitti_360_labels:
    category = label.category
    if category in category2kitti_360_labels:
        category2kitti_360_labels[category].append(label)
    else:
        category2kitti_360_labels[category] = [label]
...
if __name__ == "__main__":
    # Print all the kitti_360_labels
